...
const DanceClasses = () => {
    const { ref: danceRef, inView: danceVisible } = useInView<HTMLDivElement>({ threshold: 0.1 });
    ...
    <section className="music-lessons">
      <div className="music-lessons-inner">
        <div
          ...
          ref={danceRef}
        >
          <img src="https://i.imgur.com/xzDFa5h.jpeg" alt="Dance Classes" />
        </div>
        <div className="music-text-container">
          <div className={`class-box slide-right ${danceVisible ? 'show' : ''}`}>
          <h1>DANCE CLASSES</h1>
        <p>
