...
const WhyUs = () => {
  const { ref: whyUsRef, inView: whyUsVisible } = useInView<HTMLDivElement>({ threshold: 0.5 });

  return (
    <section className="why-us" ref={whyUsRef}>
      <div className={`why-us-content fade-up ${whyUsVisible ? 'show delay-3' : ''}`}>
      ...
      <div className={`why-us-values fade-up ${whyUsVisible ? 'show delay-4' : ''}`}>
