...
const MusicClasses = () => {
  const { ref: bandRef, inView: bandVisible } = useInView<HTMLDivElement>({ threshold: 0.1 });
      ...
      <div className="band-program-inner">
        ...
        >
          <div className="class-box">
            <h1>MUSIC CLASSES</h1>
            <p>
              We are proud to announce that we are now offering music lessons from 
              talented instructors in piano, violin, and vocal!
            </p>
        ...
        <div className={`band-image-container slide-right ${bandVisible ? 'show' : ''}`}>
          <img 
